      ...
      <div className="bg-gray-800 bg-opacity-75 p-6 rounded-lg shadow-xl overflow-hidden group transition-transform duration-300 hover:scale-105 flex flex-col md:flex-row items-center">
        ...
        <div className="flex-1 relative">
          <p className="text-gray-300 text-lg leading-relaxed mb-4">
            Dedicated IT Support Specialist with over 2.5 years of experience in technical support, data analysis, and customer service. Currently advancing technical expertise through a Data Science Course and a Bachelor's in Computer Science.
          </p>
          <p className="text-gray-300 text-lg leading-relaxed mb-4">
